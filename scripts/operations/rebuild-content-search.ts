...
if ((await fuseki.commandHealth()).moduleVersion !== '0.5.10') {
  throw new Error('Fuseki command module 0.5.10 is required; run yarn toolchain:install and restart the stack');
}
