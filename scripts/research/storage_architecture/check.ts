...
for(const cmd of [['bun','node_modules/typescript/bin/tsc','--project','services/main/tsconfig.json'],['bun','scripts/api/eden-gate.ts'],['bun','node_modules/typescript/bin/tsc','--project','services/account/tsconfig.json'],['bun','node_modules/typescript/bin/tsc','--project','services/content/tsconfig.json'],['bun','node_modules/typescript/bin/tsc','--project','packages/model/tsconfig.json'],['bun','node_modules/typescript/bin/tsc','--project','packages/ui/tsconfig.json'],['bun','node_modules/typescript/bin/tsc','--project','apps/web/tsconfig.json'],['bun','node_modules/typescript/bin/tsc','--project','scripts/research/storage_architecture/tsconfig.json'],['yarn','gen:check'],['yarn','docs:check']]) {
