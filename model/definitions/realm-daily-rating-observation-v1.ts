...
export const realmDailyRatingObservationProfile = {
  id: 'realm-daily-rating-observation-v1',
  comments: [
    'One Account-principal daily slot for one MainVersion and Realm question.',
  ...
  shapes: [
    {
      iri: 'https://rezics.com/definition/realm-daily-rating-observation-v1/realm-shape',
      properties: [
    ...
    {
      iri: 'https://rezics.com/definition/realm-daily-rating-observation-v1/context-shape',
      properties: [
        { path: 'rdf:type', hasValue: 'rv:RatingContext' },
        { path: 'rdf:type', hasValue: 'rv:DailyRatingContext' },
        { path: 'rv:ratingTimeZone', minCount: 1, maxCount: 1, datatype: 'xsd:string', minLength: 1, maxLength: 100 },
        fixed('rv:ratingCalendar', '<https://rezics.com/definition/rating-iso-calendar-v1>'),
        ...
        fixed('rv:ratingCadence', '<https://rezics.com/definition/rating-daily-v1>', [1]),
    ...
    {
      iri: 'https://rezics.com/definition/realm-daily-rating-observation-v1/work-shape',
      properties: [
    ...
    {
      iri: 'https://rezics.com/definition/realm-daily-rating-observation-v1/main-shape',
      properties: [
    ...
    {
      iri: 'https://rezics.com/definition/realm-daily-rating-observation-v1/observation-shape',
      properties: [
        { path: 'rdf:type', hasValue: 'rv:RatingObservation' },
        { path: 'rdf:type', hasValue: 'rv:DailyRatingObservation' },
        { path: 'rv:ratingDay', minCount: 1, maxCount: 1, datatype: 'xsd:string', pattern: '^\\d{4}-\\d{2}-\\d{2}$' },
        { path: 'rv:ratingTimeZone', minCount: 1, maxCount: 1, datatype: 'xsd:string', minLength: 1, maxLength: 100 },
        fixed('rv:ratingCalendar', '<https://rezics.com/definition/rating-iso-calendar-v1>'),
        ...(['rv:periodStart', 'rv:periodEnd'] as const).map(path => ({ path, minCount: 1, maxCount: 1, datatype: 'xsd:dateTime' as const })),
    ...
    {
      iri: 'https://rezics.com/definition/realm-daily-rating-observation-v1/revision-shape',
      properties: [
        { path: 'rdf:type', hasValue: 'rv:RatingObservationRevision' },
        { path: 'rdf:type', hasValue: 'rv:DailyRatingObservationRevision' },
        { path: 'rv:ratingDay', minCount: 1, maxCount: 1, datatype: 'xsd:string', pattern: '^\\d{4}-\\d{2}-\\d{2}$' },
        { path: 'rv:ratingTimeZone', minCount: 1, maxCount: 1, datatype: 'xsd:string', minLength: 1, maxLength: 100 },
        fixed('rv:ratingCalendar', '<https://rezics.com/definition/rating-iso-calendar-v1>'),
        ...(['rv:periodStart', 'rv:periodEnd'] as const).map(path => ({ path, minCount: 1, maxCount: 1, datatype: 'xsd:dateTime' as const })),
