...
export const realmDailyRatingContextProfile = {
  id: 'realm-daily-rating-context-v1',
  comments: ['First Realm rating question: one MainVersion daily opinion per Account principal.'],
  prefixes: [
  ...
  shapes: [
    {
      iri: 'https://rezics.com/definition/realm-daily-rating-context-v1/realm-shape',
      properties: [
    ...
    {
      iri: 'https://rezics.com/definition/realm-daily-rating-context-v1/context-shape',
      properties: [
        ...
        { ...fixed('rv:ratingScaleMax', '10'), datatype: 'xsd:integer',
          lineBreaks: [{ after: 3, indent: 18 }] },
        fixed('rv:ratingCadence', '<https://rezics.com/definition/rating-daily-v1>', true),
