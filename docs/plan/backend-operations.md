...
| LIVE04-LIVE06 | E `GET /v1/sources/conversions/{base}/child-correspondences/{candidate}` for a read-only occurrence assessment; P `POST /v1/sources/correspondences`; P `POST /v1/sources/withdrawals`. |
