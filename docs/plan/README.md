...
| Status | The current management Goal started at 03:57:20 UTC on clean `f2c8aa1`. G-001 through G-024 and manager G-027 are integrated and affected-verified on `main`; G-025 Rating aggregation and G-026 npm composition are active in independent worktrees. IAM06, IAM23, IAM24, RATE02 and RATE03 are declared complete-case candidates with passing selected owner checks, not recorded backend qualification. The last broad historical run `20260925t151147-02d115` passed 11 of 277 mixed cases; no `yarn qa --backend --record` result exists. See the [active management program](#active-management-program) and generated [qualification page](qualification.md). |
| Next action | G-025 and G-026 handoffs are integrated serially with affected real-owner checks. G-028's independent Work-title control-epoch brief is ready for the next released worker slot. The IAM06 and IAM24 declarations still await final recorded backend QA. Preserve all field control, ecosystem, recovery and remaining owner schema requirements; final reconstruction and recorded backend QA remain the final gate. |
...
| [G-025](../goals/tasks/G-025.md) / RATE01 | Three explicit experience aggregation policies over effective private-principal observations. | Running in independent Rating/model worktree task `01a0dd01-d49c-7f33-b4a6-7eaef1fcf470` from G-022 verified `106fa9c`. The 2,2,8 plus 6 counterexample must produce latest-per-rater 7, mean-per-rater 5 and pooled-observation 4.5 with separate names and denominators. G-024 owns a disjoint Access transfer; manager integrates shared routes and generated artifacts serially. |
| [G-026](../goals/tasks/G-026.md) / PKG04 | Compose exact npm alias/workspace identities with target-specific optional/platform projection. | Running in independent package worktree task `01a0dd0c-d46b-7482-9f86-7002aad7bf04` from clean `37fe902`. G-021 v2 and G-023 v3 remain byte-frozen; the new version must prove one combined bounded virtual tree against pinned npm and preserve explicit omissions, peers and source identities. Override/engine, broad workspaces, other ecosystems and installation stay retained. |
...
| [G-028](../goals/tasks/G-028.md) / LIVE03 | Owner-enforced Work title editorial-control epoch and explicit source-control return. | Ready after either worker releases a slot, from then-current clean verified `main`. Existing source adoption, refresh assessment, guarded title application and equal-value human/source CAS supply foundations, but full source/human control and generic protection remain unqualified. The brief keeps exact owner CAS, distinct return authority, real recovery and bounded cost in scope; Rating and npm owner work are independent. |
