...
| Deliverables | S0 pinned Fuseki/TDB2/jena-text drill and evidence; S1 fixed model/shape profile, guarded Main Work commands, receipts/outbox, Account/Access admission, isolated restore and recovery guards with their first consumers; first S2 text Contribution draft/profile, immutable create/edit history, contributor eligibility decision, private relay envelopes and retained draft replay. Next, implement guarded context selection, publication recovery replay and qualified public search; continue cross-owner recovery qualification. |
...
Account/Access/Fuseki/object storage. Guarded context selection, qualified public search and publication recovery replay remain the next S2 evidence
requirements. WORK02/03, CTX01 and SEARCH01/03
remain pending until adoption, context and disclosure paths run together. The
mixed-cut drill covers draft creation/edit and terminal outcome recovery only; it does not yet replay publication decisions.
