...
| Status | The current management Goal started at 03:57:20 UTC on clean `f2c8aa1`. G-001 through G-027, G-029 and manager G-031/G-032 are integrated and affected-verified on `main`; G-028 Work-title control has a clean committed worktree handoff awaiting serial integration. G-030 IAM26 is active in its own worktree. IAM01, IAM03, IAM06, IAM23, IAM24, RATE01, RATE02, RATE03 and RATE05 are declared new complete-case candidates with passing selected owner checks, not recorded backend qualification. The last broad historical run `20260925t151147-02d115` passed 11 of 277 mixed cases; no `yarn qa --backend --record` result exists. See the [active management program](#active-management-program) and generated [qualification page](qualification.md). |
| Next action | Integrate committed G-028 `ed05b21` with a combined Jena image and affected native/API/recovery checks. G-030 independently implements IAM26's represented A-to-B roster operation; IAM25's separate eligible-member-set selector remains next in that owner sequence. Final reconstruction and recorded backend QA remain the final gate. |
...
| [G-028](../goals/tasks/G-028.md) / LIVE03 | Owner-enforced Work title editorial-control epoch and explicit source-control return. | Recovery worker handed off clean `ed05b21` from the independent Work/Source worktree. Selected native/model `20260926t105709-004ea3`, title API `20260926t110130-337ca3`, Source API `20260926t105921-e4252f`, graph-loss recovery `20260926t110049-d25ec4`, private/content `20260926t110307-f01b41`, Rating recovery `20260926t110346-e4f38d`, units, generation, backend static and docs passed. Await manager integration; LIVE03 and generic protection remain partial until merged evidence is reviewed. |
