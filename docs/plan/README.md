...
| Phase | S0 graph substrate verified; S1 internal Work activation/storage verified in part. Account/Access admission, edit/history and full S1 cases are next. S2–S3 and remaining stages are pending. |
...
| Qualification | S0 OPS14 and substrate OPS16 passed. The internal S1 storage test passed its scoped SYS02/SYS10/SYS14 cases with real Fuseki, plus Bun type checking and immutable Yarn install. Product G2–G6 and complete S1–S3 remain pending. |
