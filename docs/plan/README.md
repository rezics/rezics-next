...
| Qualification | S0 OPS14 and substrate OPS16 passed. S1 tests passed scoped SYS02/SYS09/SYS10/SYS14, create/edit IAM07 fences, exact immutable history, a partial G3 Account/Access/Main/Fuseki HTTP path, partial OPS03/SYS13 isolated restore and deletion guard, and partial SYS04/SYS05/SYS12 outbox handoff on Fuseki 6.2.0/PostgreSQL 18.6. Complete G2–G6 and S1–S3 remain pending. |
