...
| [G-015](../goals/tasks/G-015.md) / RATE03 | Daily Rating slot keyed by server calendar and private principal across DST/persona changes. | Prepared for a Rating/model worktree; seek full RATE03 real-owner proof while preserving standing receipts and recovery. RATE02/RATE03 remain open until merged evidence. |
