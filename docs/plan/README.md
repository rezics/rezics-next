...
| Deliverables | S0 pinned Fuseki/TDB2/jena-text drill and evidence; S1 fixed model/shape profile, guarded Main Work commands, receipts/outbox, Account/Access admission, isolated restore and recovery guards with their first consumers; first S2 text Contribution draft profile, admission, immutable history and private relay envelope. Next, implement expected-head draft edit, guarded publication and qualified public search; continue cross-owner recovery qualification. |
...
Account/Access/Fuseki/object storage. Expected-head draft edit and publication
remain the next S2 evidence requirements. WORK02/03, CTX01 and SEARCH01/03
remain pending until adoption, context and disclosure paths run together. The
mixed-cut drill covers draft creation/cancellation recovery only.
