...
| P0.7 | README, installation, service READMEs and model README describe the actual commands. | `yarn docs:check` passes; the documented commands run as written. | Partial: root README and model README now state the working P0.1/P0.3/P0.4 commands and their limits. Installation and service READMEs still need reconciliation after P0.2/P0.8; verify their commands at those gates. |
