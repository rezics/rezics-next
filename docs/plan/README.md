...
| Next action | Integrate G-022's committed Rating experience handoff and repeat affected checks on merged source; then integrate G-023's npm alias/workspace handoff when finished. G-024 atomic Org/Realm transfer is now active in a separate Access worktree. Preserve all field control, ecosystem, recovery and remaining owner schema requirements; final reconstruction and recorded backend QA remain the final gate. |
...
| [G-022](../goals/tasks/G-022.md) / RATE02 | Versioned experience Rating observation identity and exact-head revision, independent of G-020 moderation. | Running in independent Rating/model worktree task `01a0dcdd-43d7-7a30-902e-e03740f19fc7` from clean `001b514`. G-015's daily profile and standing corrections establish two cadences; complete RATE02 requires an intentional experience occasion to create a distinct Observation, with correction retaining identity and real-owner/recovery evidence. Shared Main route and generated artifacts enter the manager's serial integration queue. |
| [G-023](../goals/tasks/G-023.md) / PKG04 | Bounded npm alias and workspace lock identity versus pinned offline npm 11.19.1. | Running in independent package worktree task `01a0dce4-6caf-7960-916a-5f761b191811` from clean `fc23357`. G-019/G-021 provide exact npm v1/v2 receipts and virtual-tree oracle; this slice adds separately versioned alias/workspace semantics while G-022 owns Rating/model. Main routes and generated artifacts enter the manager's serial integration queue. Remaining override/engine, live resolution, artifact and installation assertions stay retained. |
