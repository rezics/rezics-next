...
| Status | The current management Goal started at 03:57:20 UTC on clean `f2c8aa1`. G-001 through G-027 are integrated and affected-verified on `main`; G-028 Work-title control and G-029 Rating policy revision are active in independent worktrees. IAM06, IAM23, IAM24, RATE01, RATE02 and RATE03 are declared complete-case candidates with passing selected owner checks, not recorded backend qualification. The last broad historical run `20260925t151147-02d115` passed 11 of 277 mixed cases; no `yarn qa --backend --record` result exists. See the [active management program](#active-management-program) and generated [qualification page](qualification.md). |
| Next action | G-028 Work-title control and G-029 Rating policy revision are active in independent owner worktrees. G-030 IAM25/IAM26 is ready for the next independent Access slot. The manager serially integrates handoffs with affected real-owner checks. Preserve all field control, ecosystem, recovery and remaining owner schema requirements; final reconstruction and recorded backend QA remain the final gate. |
...
| [G-028](../goals/tasks/G-028.md) / LIVE03 | Owner-enforced Work title editorial-control epoch and explicit source-control return. | Running in independent Work/Source worktree task `01a0dd21-6f4e-7950-b4e0-a4efc2929e24` from clean `003975d`. Existing source adoption, refresh assessment, guarded title application and equal-value human/source CAS supply foundations, but full source/human control and generic protection remain unqualified. The brief keeps exact owner CAS, distinct return authority, real recovery and bounded cost in scope. |
| [G-029](../goals/tasks/G-029.md) / RATE05 | Distinguish a new Rating question/Context from an immutable aggregate-default policy revision and real default consumer. | Running in independent Rating worktree task `01a0dd2b-024a-7882-b412-48302629f5e7` from verified `5d533df`. The counterexample must change a context-default result from 7 to 5 without changing Context identity or relabeling explicit 7/5/4.5 policies; question edits create another Context. G-028 Work/Source is independent; shared Main/model artifacts enter the manager's serial integration queue. |
| [G-030](../goals/tasks/G-030.md) / IAM25–IAM26 | One bounded organization membership-administration authority path distinguishing explicit representation from direct eligible-member selection. | Ready for the next Access worktree slot. The contract already separates organization-subject grants, eligible-member-set grants and principal-to-Agent representation; existing `work.create` representation proves only a narrower profile. This brief retains the real operation, exact negative and positive paths, replay/recovery and bounded cost; no IAM25/IAM26 completion is claimed before merged evidence. |
