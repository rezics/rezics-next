...
| Next action | Design a bounded route index for later merges of an existing merge target without losing earlier direct or renamed links. B29 remains open while independent backend cases continue. Final reconstruction and recorded backend QA remain the final gate. |
