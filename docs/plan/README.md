...
public MatchUnit can be derived. The first exit evidence is real Account/Access/
Fuseki/object create, replay, stale/denied edit, exact draft read and no public
text match before publication. WORK02/03, CTX01 and SEARCH01/03 remain pending
