...
| Status | The current management Goal started at 03:57:20 UTC on clean `f2c8aa1`. G-001 through G-008 are integrated and affected-verified on `main`; PKG01/PKG02/PKG05/PKG12/PKG13/PKG14/PKG20, IAM06 and IAM33 remain partial. The last broad historical run `20260925t151147-02d115` passed 11 of 277 mixed cases; it is not a complete backend qualification. No `yarn qa --backend --record` result exists yet. See the [active management program](#active-management-program) and generated [qualification page](qualification.md). |
| Next action | G-009 owns private group/role membership dependency and G-010 owns explicit source title-support withdrawal in independent worktrees. Integrate each clean handoff with merged affected checks. Keep wider Realm participation explicit. Preserve source child adoption, complete field control, package ecosystems, recovery and the remaining owner schemas; final reconstruction and recorded backend QA remain the final gate. |
...
| [G-008](../goals/tasks/G-008.md) / PKG01 | First bounded Cargo resolver snapshot and native oracle; independent of G-006. | Integrated and affected-verified on `abc8a48`: Cargo unit 2/2, pinned Cargo 1.98.1 local registry oracle, real Account/Access/PostgreSQL API `20260926t052253-6797d9`, `yarn check:backend` and docs checks passed on merged source. PKG01/PKG02/PKG12/PKG13 remain partial; worker task `01a0dc18-e688-70a3-8537-495f11a4e9fa` finished. |
| [G-009](../goals/tasks/G-009.md) / IAM06 | Private-principal membership dependent group and role authority, exact episode claim; depends on G-006. | Running in worktree task `01a0dc1d-e68d-7640-a089-959d09fa0090` from clean `0510374`; schema and API boundaries are being mapped. Preserve privacy and independent authority; IAM06/IAM33 remain partial. |
| [G-010](../goals/tasks/G-010.md) / LIVE05 | Explicit withdrawal of one title-only source support while preserving exact Work and human control. | Running in independent worktree task `01a0dc2b-293d-7951-8a1d-85254cb55763` from clean `abc8a48`; owner receipt, private authority and restoration design precede implementation. LIVE05/OPS03 remain partial. |
| [G-011](../goals/tasks/G-011.md) / PKG02 | Versioned exact Cargo `links` conflict proof against pinned native Cargo. | Prepared after G-008 merged checks for a package worktree when one active worker finishes; yanked-lock eligibility remains a separate gap. PKG02/PKG12/PKG13 remain partial. |
