...
| [G-021](../goals/tasks/G-021.md) / PKG04 | Versioned npm optional dependency and OS/CPU topology under pinned npm 11.19.1. | Running in independent package worktree task `01a0dcc2-13c1-7ed2-baa9-196f483e7057` from clean `b760a7a`. Package-owner npm module and offline oracle are independent of G-020's Access/Realm write boundary; the manager sequences shared Main routes/generated artifacts at integration. Optional and platform outcomes are partial PKG04/PKG12/PKG13; aliases, workspaces, overrides, live resolution, artifacts and installation remain retained. |
