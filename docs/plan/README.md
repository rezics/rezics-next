...
| [G-019](../goals/tasks/G-019.md) / PKG03 | Bounded npm lockfile-v3 nested-instance and peer-host topology against a pinned offline native oracle. | Running in independent package worktree task `01a0dc9d-2462-7df3-9090-26f2ab24f871` from clean `c2a2f55`. Toolchain must admit the exact npm oracle before invocation. PKG03/PKG12/PKG13 remain partial until merged evidence and wider profiles. |
| [G-020](../goals/tasks/G-020.md) / IAM23 | Realm-local moderation of one organization-authored selected publication, with exact admitted episode and local-only effect. | Ready for the next independent Access/Work slot; existing admitted contribution author and selected contribution/publication decision provide a candidate durable publisher binding for the worker to prove. Combine with G-012 suspension to target a complete IAM23 candidate; declare it only after whole-row merged evidence. No worker claimed. Moves, quota/review and paid benefits remain retained. |
