...
| P0.7 | README, installation, service READMEs and model README describe the actual commands. | `yarn docs:check` passes; the documented commands run as written. | Partial: root README, model README, toolchain page and test-harness page now distinguish working P0.1/P0.3/P0.4 commands from pending gates. Installation and service READMEs still need reconciliation after P0.2/P0.8; verify their commands at those gates. |
