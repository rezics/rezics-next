...
records 310 assertions with no failures. It provisions distinct classification
...
records 297 assertions with no failures. It rejects replay without retained
...
The [Realm standing RatingObservation candidate result](../../model/tests/evidence/2026-09-24-realm-standing-rating-observation-profile.json) records three conforming submission, correction and withdrawal cases and eight rejected type, link, opaque slot, value, predecessor and time cases under pinned Jena SHACL 6.2.0/Java 21. It fixes one Account-principal/MainVersion/question standing slot, exact revision head, available 1–10 or valueless withdrawal and four typed event times. This is scoped MODEL15/17 candidate evidence only. Next, install guarded Account/Access admission, unique slot and exact-head revision, immutable history, typed relay and retained replay; then aggregate effective opinions and join rating with public classified text.
