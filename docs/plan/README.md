...
| [G-018](../goals/tasks/G-018.md) / LIVE04 | One source-qualified Open Library author occurrence becomes an explicit native Work credit. | Prepared for a Source/model slot after G-016 handoff; source-only correspondence cannot create native child identity. LIVE04/MODEL05/MODEL06 remain partial. |
