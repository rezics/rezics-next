...
| [G-023](../goals/tasks/G-023.md) / PKG04 | Bounded npm alias and workspace lock identity versus pinned offline npm 11.19.1. | Ready for a fresh independent package worktree from merged `main`. G-019/G-021 provide exact npm v1/v2 receipts and virtual-tree oracle; this slice adds separately versioned alias/workspace semantics while G-022 owns Rating/model. Main routes and generated artifacts enter the manager's serial integration queue. Remaining override/engine, live resolution, artifact and installation assertions stay retained. |
