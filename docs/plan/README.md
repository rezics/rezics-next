...
| Phase | S0 graph substrate verified; S1 authenticated fixed-profile Work create/edit/exact revision read and Work-scoped Access checks verified in part. Restart/restore and full S1 cases are next. S2–S3 and remaining stages are pending. |
...
| Qualification | S0 OPS14 and substrate OPS16 passed. S1 tests passed scoped SYS02/SYS09/SYS10/SYS14, create/edit IAM07 fences, exact immutable history and a partial G3 Account/Access/Main/Fuseki HTTP path on Fuseki 6.2.0/PostgreSQL 18.6. Complete G2–G6 and S1–S3 remain pending. |
