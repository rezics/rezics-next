...
| Status | The current management Goal started at 03:57:20 UTC on clean `f2c8aa1`. G-001 through G-027 and manager G-031/G-032 are integrated and affected-verified on `main`; G-029 Rating policy revision has a clean committed worktree handoff awaiting serial integration, while G-028 Work-title control continues in its preserved worktree. IAM01, IAM03, IAM06, IAM23, IAM24, RATE01, RATE02 and RATE03 are declared new complete-case candidates with passing selected owner checks, not recorded backend qualification. The last broad historical run `20260925t151147-02d115` passed 11 of 277 mixed cases; no `yarn qa --backend --record` result exists. See the [active management program](#active-management-program) and generated [qualification page](qualification.md). |
| Next action | Integrate committed G-029 `4775035` with affected native/API/recovery and backend static checks while G-028 finishes. G-030 IAM26 is ready for the released Access worker slot; IAM25's separate eligible-member-set selector remains next in that owner sequence. The manager integrates G-028 later with a combined Jena image and affected checks. Final reconstruction and recorded backend QA remain the final gate. |
...
| [G-028](../goals/tasks/G-028.md) / LIVE03 | Owner-enforced Work title editorial-control epoch and explicit source-control return. | Recovery worker `/root/g028_recovery` owns the preserved independent Work/Source worktree from `003975d`; original task `01a0dd21-6f4e-7950-b4e0-a4efc2929e24` is interrupted. Existing source adoption, refresh assessment, guarded title application and equal-value human/source CAS supply foundations, but full source/human control and generic protection remain unqualified. The brief keeps exact owner CAS, distinct return authority, real recovery and bounded cost in scope. |
| [G-029](../goals/tasks/G-029.md) / RATE05 | Distinguish a new Rating question/Context from an immutable aggregate-default policy revision and real default consumer. | Recovery worker handed off clean `4775035` from the independent Rating worktree. Worker selected checks passed: 46 units, native model `20260926t105420-3ef430`, native equivalence `20260926t110242-439682`, real Account/Access/Main/Jena API and graph-loss recovery `20260926t110128-5a4787`, generation, backend static and docs. Await manager cherry-pick and merged checks before calling RATE05 verified. |
| [G-030](../goals/tasks/G-030.md) / IAM26 | One bounded organization membership-administration authority path through explicit A representation and A's B grant. | Ready for the next Access worktree slot. Existing `work.create` representation proves only a narrower profile. This brief retains a real member operation, exact negative and positive paths, replay/recovery and bounded cost. Its implicit-status denial contributes to IAM25, but IAM25 stays partial until a distinct eligible-member-set selector is qualified. No IAM26 completion is claimed before merged evidence. |
