...
public MatchUnit can be derived. The draft create, replay, denied read, exact immutable read and absence of public
text are locally exercised through real Account/Access/Fuseki/object storage.
Stale/denied draft edit and publication remain the next S2 evidence requirements. WORK02/03, CTX01 and SEARCH01/03 remain pending
until adoption, context and disclosure paths run together. Existing S1 recovery
drills do not qualify those S2 behaviors.
