...
| [G-020](../goals/tasks/G-020.md) / IAM23 | Realm-local moderation of one organization-authored selected publication, with exact admitted episode and local-only effect. | Ready for the next independent Access/Work slot; existing admitted contribution author and selected contribution/publication decision provide a candidate durable publisher binding for the worker to prove. No worker claimed. Other Realm management, moves, quota/review and paid benefits remain retained. |
