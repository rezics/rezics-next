...
Build Space (Realm and Zone), Context, semantic classification/ratings and REZICS
...
| M02 Knowledge | Concepts/types/claims/evidence, contextual interpretation, typed relations and bounded inference. | [Semantic model](../contracts/semantic-model.md), [classification](../contracts/classification.md). |
...
3. Join a Realm, classify/rate in its context, and present its accepted view through a Zone.
