...
| Fuseki | `rezics/fuseki:6.2.0-cmd0.5.29`, local build pending | G-028/G-029 combined owner integration | Combines the Rating policy and Work title control profiles with both native command guards. Build through `yarn toolchain:install` and run merged affected checks before using this image as evidence. |
