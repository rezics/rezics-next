...
| Fuseki | `rezics/fuseki:6.2.0-cmd0.5.25`, built locally | G-022; selected native `20260926t090200-a6109e`, API/recovery `20260926t090251-7b7a83` and standing withdrawal `20260926t090346-d32b96` passed | Adds separate experience Rating profiles, exact occasion/predecessor/time bindings and canonical type selection. Existing standing/daily digests and all 66 historical outcomes are preserved. Manager integrates source and generated artifacts serially; full backend qualification remains separate. |
