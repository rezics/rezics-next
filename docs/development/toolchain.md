...
| Fuseki | `rezics/fuseki:6.2.0-cmd0.5.24`, built locally | Adopted for G-018; selected API `20260926t074730-1831a8`, model `20260926t074739-acebf1` and recovery `20260926t074730-20dab9` passed | Adds the bounded immutable Work author-credit profile, exact receipt/source-intent binding and transactional Work head/protection checks. Existing profiles retain their digests. Full backend qualification remains separate. |
