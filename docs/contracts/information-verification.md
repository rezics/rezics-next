...
Basis: [PROV-O](https://www.w3.org/TR/prov-o/). Qualify exact provenance, circular
sources, missing evidence, correction, independent export and bounded reassessment.
