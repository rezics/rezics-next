...
Graph hold release now compares the promoted restored Account database's WAL
replay position and complete pinned Better Auth row digest with the authenticated
source coverage on every release.
